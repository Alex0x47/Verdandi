...
export class Verdandi {
    ...
    constructor(lang = "fr", options = {}) {
        ...
        this.DEFAULT_HOURS_MINUTES_SEPARATOR = options.hoursMinutesSeparator != null ? options.hourSeparator : ":";
        this.DEFAULT_MINUTES_SECONDS_SEPARATOR = options.minutesSecondsSeparator != null ? options.hourSeparator : ":";
    ...
    /**
     * To implement
     * @param {*} timestamp : timetamp to convert
     * @param {*} options :
     * separator : wanted separator between hour and minutes
     */
    getHoursMinutesSeconds(timestamp, options = {}) {
        var finaleHoursMinutesSeparator = options.hourminSeparator != null ? options.hourminSeparator : this.DEFAULT_HOURS_MINUTES_SEPARATOR;
        var returnedValue = this.getHours(timestamp) + finaleHoursMinutesSeparator + this.getMinutes(timestamp);
        if(options.showSeconds === true){
            var finaleMinutesSecondsSeparator = options.minsecSeparator != null ? options.minsecSeparator : this.DEFAULT_MINUTES_SECONDS_SEPARATOR;
            returnedValue += finaleMinutesSecondsSeparator + this.getSeconds(timestamp);
        }
